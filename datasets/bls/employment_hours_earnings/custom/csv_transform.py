...
def trim_whitespaces(df):
    cols = ["series_id","value","footnote_codes","series_title"]
    df[cols] = df[cols].apply(lambda x: x.str.strip())
    return df[cols]

def filter_headers(df):
    cols=["begin_period","begin_year","data_type_code","end_period","end_year","industry_code","seasonal","supersector_code"]
